...
*/
-- Clear seed data so NOT NULL columns can be added (data will be re-seeded per-user)
TRUNCATE TABLE "transactions", "accounts", "goals", "loans" RESTART IDENTITY CASCADE;
...
-- AlterTable
ALTER TABLE "loans" ADD COLUMN     "user_id" TEXT NOT NULL;
